...
<body>       
 <div class="jumbotron" style="border-radius:0;background:url('image.jpg');background-size:cover;height:400px;"></div>
...
<a href="payment.php" class="list-group-item">Payments</a></div>
<hr>
	<div class="list-group">
...
<a href="func.php" class="btn btn-light"></a></form>
</div>
    </div>
		</div>
